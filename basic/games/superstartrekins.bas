...
120 PRINT"     COMMAND S (NAV,SRS,LRS,PHA,TOR,SHE,DAM,COM,OR XXX)."
130 PRINT"2. IF YOU SHOULD TYPE IN AN ILLEGAL COMMAND, YOU'LL GET A SHORT"
140 PRINT"     LIST OF THE LEGAL COMMAND S PRINTED OUT."
150 PRINT"3. SOME COMMAND S REQUIRE YOU TO ENTER DATA (FOR EXAMPLE, THE"
...
310 PRINT"GALAXY TO BEGIN A TOUR OF DUTY AS COM AND ER OF THE STARSHIP"
...
340 PRINT"PLANETS."
360 PRINT
370 PRINT"     YOU HAVE THE FOLLOWING COMMAND S AVAILABLE TO YOU AS CAPTAIN"
...
500 PRINT"     ONE QUADTANT.  THEREFOR E, TO GET"
...
670 PRINT"     THE SCAN IS CODED IN THE FOR M \###\, WHERE TH UNITS DIGIT"
