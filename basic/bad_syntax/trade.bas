...
1260 IF A1>3  AND A3>3  AND A3<>A1  THEN  GOSUB 2220 MOD REM   THE MERGER SUB.
...
2080 PRINT  TAB(21);"*******************"
2090 PRINT  TAB(15);"A  B  C  D  E  F  G  H  I  J  K  L"
2100    FOR R2=1  TO 9
2110 PRINT"         ";R2;" ";
2120 FORC2=1TO12
2130 PRINT" ";
...
4390 PRINT  TAB(16);"** GAME ENDS AFTER 99 MOVES **"
