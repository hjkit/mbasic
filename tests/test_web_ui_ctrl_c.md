...
## Problem
After running programs in the web UI for a while, `Ctrl+C` stops working in the shell that launched `./mbasic.py --backend web`. User has to use `Ctrl+Z` and `kill`.
...
1. Start web UI: `./mbasic.py --backend web`
