...
""")
    ...
    child = pexpect.spawn('python3 mbasic.py --backend curses-npyscreen test_continue.bas',
...
""")
    ...
    child = pexpect.spawn('python3 mbasic.py --backend curses-npyscreen test_edit.bas',
                          encoding='utf-8', dimensions=(24, 80), timeout=10)
