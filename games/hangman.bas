...
20 PRINT TAB(15);"CREATIVE COMPUTING  M OR RISTOWN, NEW JERSEY"
...
95 IF C<N THEN 100
97 PRINT "YOU DID ALL THE W OR DS!!": STOP
100 Q=INT(N*RND(1))+1
...
230 IF G$=N$(I) THEN PRINT "YOU GUESSED THAT LETTER BEF OR E!": GOTO 170
...
330 INPUT "WHAT IS YOUR GUESS FOR THE W OR D";B$
340 IF A$=B$ THEN 360
350 PRINT "WRONG.  TRY ANOTHER LETTER.": PRINT: GOTO 170
360 PRINT "RIGHT!!  IT TOOK YOU";T1;"GUESSES!"
370 INPUT "WANT ANOTHER W OR D";W$: IF W$="YES" THEN 50
380 PRINT: PRINT "IT'S BEEN FUN!  BYE FOR NOW.": GOTO 999
390 PRINT "YOU FOUND THE W OR D!": GOTO 370
400 PRINT: PRINT: PRINT"S OR RY, THAT LETTER ISN'T IN THE W OR D."
...
455 PRINT "NOW WE DRAW ON E FOOT": GOTO 470
...
600 PRINT "S OR RY, YOU LOSE.  THE W OR D WAS ";A$
610 PRINT "YOU MISSED THAT ON E.  DO YOU ";: GOTO 370
620 INPUT "TYPE YES OR NO";Y$: IF LEFT$(Y$,1)="Y" THEN 50
700 DATA "GUM","SIN","FOR","CRY","LUG","BYE","FLY"
710 DATA "UGLY","EACH","FROM","W OR K","TALK","WITH","SELF"
720 DATA "PIZZA","THING","FEIGN","FIEND","ELBOW","FAULT","DIRTY"
730 DATA "BUDGET","SPIRIT","QUAINT","MAIDEN","ESC OR T","PICKAX"
