...
2020 PRINT:PRINT"** FATAL ERROR **   YOU'VE JUST STR AND ED YOUR SHIP IN "
...
2220 PRINT"  TOR  (TO FIRE PHOTON T OR PEDOES)"
...
2360 PRINT"WARP FACTOR (0-";X$;")";:INPUTW1:IF D(1)<0 AND W1>.2 THEN 2470
...
4270 PRINT"SCIENCE OFFICER SPOCK REPORTS  'SENS OR S SHOW NO ENEMY SHIPS"
...
4690 REM PHOTON T OR PEDO CODE BEGINS HERE
4700 IF P<=0 THEN PRINT"ALL PHOTON T OR PEDOES EXPENDED":GOTO 1990
4730 IF D(5)<0 THEN PRINT"PHOTON TUBES ARE NOT OPERATIONAL":GOTO 1990
4760 INPUT"PHOTON T OR PEDO COURSE (1-9)";C1:IF C1=9 THEN C1=1
...
5390 GOTO 6270
5400 PRINT"STARFLEET COMMAND REVIEWING YOUR REC OR D TO CONSIDER"
...
5840 INPUT "WILL YOU AUTH OR IZE THE REPAIR ORDER (Y/N)";A$
...
6310 PRINT"THE FEDERATION IS IN NEED OF A NEW STARSHIP COMMAND ER"
...
6730 PRINT:PRINT"*** SHORT RANGE SENS OR S ARE OUT ***":PRINT:RETURN
...
7070 PRINT"        PHOTON T OR PEDOES  ";INT(P):GOTO 7260
...
7374 PRINT"   2 = PHOTON T OR PEDO DATA"
...
8060 REM T OR PEDO, BASE NAV, D/D CALCULATOR
...
8510 PRINT"MR. SPOCK REPORTS,  'SENS OR S SHOW NO STARBASES IN THIS";
...
8794 G2$="SHORT RANGE SENS OR S":RETURN
...
9020 REM CALL WITH G5=1 TO GET REGION NAME ON LY
