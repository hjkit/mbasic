...
2 PRINT TAB(15);"CREATIVE COMPUTING  M OR RISTOWN, NEW JERSEY"
3 PRINT:PRINT:PRINT
4 DIM B(70),T(9,9)
...
22 PRINT "WILL BE USED DURING PLAY.  REFER TO THE ABOVE ON E FOR PEG"
...
1612 PRINT "BRAVO!  YOU MADE A PERFECT SC OR E!"
1613 PRINT "SAVE THIS PAPER AS A REC OR D OF YOUR ACCOMPLISHMENT!"
