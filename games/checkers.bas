...
10 PRINT TAB(15);"CREATIVE COMPUTING  M OR RISTOWN, NEW JERSEY"
...
30 PRINT "SQUARES ARE REFERRED TO BY A CO OR DINATE SYSTEM."
35 PRINT "(0,0) IS THE LOWER LEFT C OR NER"
40 PRINT "(0,7) IS THE UPPER LEFT C OR NER"
45 PRINT "(7,0) IS THE LOWER RIGHT C OR NER"
50 PRINT "(7,7) IS THE UPPER RIGHT C OR NER"
