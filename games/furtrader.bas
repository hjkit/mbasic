...
4 PRINT TAB(15);"CREATIVE COMPUTING  M OR RISTOWN, NEW JERSEY"
6 PRINT: PRINT: PRINT
15 GOSUB 1091 
16 LET I=600
...
1092 PRINT "1776 LEAVING THE LAKE ON TARIO AREA TO SELL FURS AND GET"  
1093 PRINT "SUPPLIES FOR THE NEXT YEAR.  YOU HAVE A CHOICE OF THREE"
1094 PRINT "FOR TS AT WHICH YOU MAY TRADE.  THE COST OF SUPPLIES"
1095 PRINT "AND THE AMOUNT YOU RECEIVE FOR YOUR FURS WILL DEPEND" 
1096 PRINT "ON THE FOR T THAT YOU CHOOSE." 
1099 RETURN 
1100 PRINT "YOU MAY TRADE YOUR FURS AT FOR T 1, FOR T 2,"
1102 PRINT "OR FOR T 3.  FOR T 1 IS FOR T HOCHELAGA (MONTREAL)"
1103 PRINT "AND IS UNDER THE PROTECTION OF THE FRENCH ARMY."  
1104 PRINT "FOR T 2 IS FOR T STADACONA (QUEBEC) AND IS UNDER THE" 
1105 PRINT "PROTECTION OF THE FRENCH ARMY.  HOWEVER, YOU MUST"
1106 PRINT "MAKE A P OR TAGE AND CROSS THE LACHINE RAPIDS." 
1108 PRINT "FOR T 3 IS FOR T NEW Y OR K AND IS UNDER DUTCH CONTROL."  
...
1116 GOTO 1110 
1120 PRINT "YOU HAVE CHOSEN THE EASIEST ROUTE.  HOWEVER, THE FOR T"  
1121 PRINT "IS FAR FROM ANY SEAP OR T.  THE VALUE"  
1122 PRINT "YOU RECEIVE FOR YOUR FURS WILL BE LOW AND THE COST"   
1123 PRINT "OF SUPPLIES HIGHER THAN AT FOR TS STADACONA OR NEW Y OR K."
1125 GOSUB 1400 
...
1137 PRINT "THE ROUTE TO NEW Y OR K.  YOU WILL RECEIVE AN AVERAGE VALUE"
...
1148 PRINT "FOR T NEW Y OR K YOU WILL RECEIVE THE HIGHEST VALUE" 
1149 PRINT "FOR YOUR FURS.  THE COST OF YOUR SUPPLIES"
1150 PRINT "WILL BE LOWER THAN AT ALL THE OTHER FOR TS."   
1152 GOSUB 1400 
...
1180 PRINT "SUPPLIES AT FOR T HOCHELAGA COST $150.00."
...
1219 PRINT "THE P OR TAGE.  YOU HAD TO LEAVE THE PELTS, BUT FOUND" 
1220 PRINT "THEM STOLEN WHEN YOU RETURNED."
1221 GOSUB 1244 
1222 GOTO 1414 
1224 PRINT "YOU ARRIVED SAFELY AT FOR T STADACONA." 
1225 GOTO 1239 
1226 GOSUB 1430 
...
1238 PRINT "NO ON E WILL BUY THEM."
1239 GOSUB 1244 
1240 GOTO 1410 
1244 PRINT "SUPPLIES AT FOR T STADACONA COST $125.00."
...
1292 PRINT "AT FOR T NEW Y OR K."
1293 GOTO 1311 
1295 GOSUB 1430 
...
1309 PRINT "YOU RECEIVE ON LY HALF THE CURRENT PRICE FOR THESE FURS."
1311 GOSUB 1320
1312 GOTO 1410 
1320 PRINT "SUPPLIES AT NEW Y OR K COST $80.00." 
1321 PRINT "YOUR TRAVEL EXPENSES TO NEW Y OR K WERE $25.00."
1322 RETURN 
1400 PRINT "DO YOU WANT TO TRADE AT ANOTHER FOR T?"
