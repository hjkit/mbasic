...
**Description:** Comment says _sync_program_to_editor() is called in start() but this method doesn't exist in the provided code
...
**Description:** Documentation claims floating point support but implementation may have issues
